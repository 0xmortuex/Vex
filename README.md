...
- **The font Vex wears** — `Ctrl+K` → Font: 23 faces for the interface (Segoe UI, Calibri, **Times New Roman**, Georgia, Garamond, Cambria…) and 5 for code, applied to every panel, menu and the new tab page. All already on the machine; nothing is downloaded.
