...
function installGlobals() {
  ...
  for (const name of ['CUSAPanel','RobloxPanel','GitHubPanel','NotesPanel','DownloadsPanel','HistoryPanel','MemoryPanel','SchedulesPanel','ShortcutsPanel','SyncSettings','AISettings','PersonasSettings','ShortcutEditor','ExtensionsSettings','PermissionsSettings','LocationSettings']) {
