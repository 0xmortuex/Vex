...
const CommandBar = {
  ...
  commands: [
    ...
    { id: 'pwhealth', label: 'Password Health', hint: 'Find reused, weak, or 2FA-less saved passwords — analyzed locally', icon: '🛡️', action: () => { if (typeof PasswordHealth !== 'undefined') PasswordHealth.open(); } },
