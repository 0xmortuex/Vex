...
const TASK_TEMPLATES = [
  ...
  { name: 'Weather Forecast', description: 'Morning weather for your city', frequency: 'daily', time: '07:30', startingUrl: 'https://weather.com/', prompt: 'Get today\'s weather: current temp, high/low, conditions.' },
