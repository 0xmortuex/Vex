...
const JobProfiles = {
  ...
  JOBS: [
    ...
    { id: 'web-dev',        name: 'Web Developer',        cat: 'Tech', theme: 'cyberpunk',  tools: ['regex', 'json', 'color', 'base64', 'uuid'] },
    ...
    { id: 'security',       name: 'Cybersecurity Analyst',cat: 'Tech', theme: 'matrix',     tools: ['hash', 'base64', 'regex', 'uuid'] },
    ...
    // General
    { id: 'general',        name: 'General / Everyday',   cat: 'General', theme: 'oxford',      tools: ['wordcount', 'color', 'uuid', 'timestamp'] },
  ],
