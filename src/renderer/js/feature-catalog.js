...
const VexFeatures = {
  ...
  ITEMS: [
    ...
    { id: 'font', phrases: 'font typeface times new roman serif letters reading', cat: 'look', cmd: 'font', name: 'The font Vex wears',
      what: 'The typeface of the browser itself \u2014 twenty-three of them, from Segoe UI to Times New Roman, plus the one used for code.' },
    { id: 'uisize', phrases: 'text too small bigger interface make vex bigger interface size density compact spacing rows too far apart accessibility', cat: 'look', cmd: 'font', name: 'How big Vex is, and how tightly packed',
      what: 'Vex\u2019s own tab strip, sidebar, menus and settings at five sizes, and four row densities \u2014 page zoom only ever made the page bigger.' },
  ...
  GROUPS: {
    ...
    privacy: [
      ...
      { name: 'The connection itself', ids: ['doh', 'https-only', 'tor', 'routing', 'routing-all', 'site-routes', 'dpi'] },
