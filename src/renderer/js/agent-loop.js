...
const AGENT_TOOLS = [
  ...
  { name: 'start_stopwatch', description: 'Start a stopwatch in Vex, counting up from zero. Use it when asked to time something of unknown length', parameters: { label: 'string (optional)' } },
