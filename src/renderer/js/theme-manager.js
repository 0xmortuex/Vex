...
const ThemeManager = {
  ...
  THEMES: [
    { id: 'oxford',     label: 'Oxford Editorial', preview: 'oxford.png' },
    { id: 'default',    label: 'Graphite',         preview: 'default.png' },
    { id: 'midnight',   label: 'Midnight',         preview: 'midnight.png' },
    { id: 'forest',     label: 'Forest',           preview: 'forest.png' },
    { id: 'ocean',      label: 'Ocean',            preview: 'ocean.png' },
    { id: 'dracula',    label: 'Dracula',          preview: 'dracula.png' },
    { id: 'nord',       label: 'Nord',             preview: 'nord.png' },
    { id: 'catppuccin', label: 'Catppuccin',       preview: 'catppuccin.png' },
  ],
