...
const DiscordMemory = {
  ...
  renderSetting(host) {
    ...
    host.innerHTML = `
      ...
      <div class="setting-toggle-row"><span>Lighter Discord — no moving avatars, emoji, stickers or GIFs, no pictures in link previews</span><label class="toggle"><input type="checkbox" data-lite><span class="toggle-slider"></span></label></div>
